...
public static void updateDate(int facultyId) {
		...
		try(Connection conn = DBconn.provideConnection()){
			...
			System.out.println(ConsoleColors.CYAN+"Enter the old day no : "+ConsoleColors.RESET);
			int dayNo = sc.nextInt();
			
			System.out.println(ConsoleColors.CYAN+"Enter the New day no :"+ConsoleColors.RESET);
